...
export const FighterUfo: React.FC<{ size?: number; hit?: boolean }> = ({
  ...
  <svg viewBox="0 0 50 40" width={size} height={(size * 40) / 50}>
    ...
    {/* 날개 */}
    <path
      d="M5,28 L20,15 L20,28Z"
      fill="#c0392b"
      stroke="#922b21"
      strokeWidth="0.8"
    />
    <path
      d="M45,28 L30,15 L30,28Z"
      fill="#c0392b"
      stroke="#922b21"
      strokeWidth="0.8"
    />
    {/* 동체 */}
    <path
      d="M25,4 L32,18 L30,34 L20,34 L18,18Z"
      fill="#e74c3c"
      stroke="#c0392b"
      strokeWidth="1"
    />
...
export const CarrierUfo: React.FC<{ size?: number; hit?: boolean }> = ({
  ...
  <svg viewBox="0 0 80 36" width={size} height={(size * 36) / 80}>
    ...
    {/* 본체 */}
    <path
      d="M10,20 Q40,2 70,20 L65,30 Q40,36 15,30Z"
      fill="#5d6d7e"
      stroke="#4a5568"
      strokeWidth="1"
    />
...
export const EliteUfo: React.FC<{ size?: number; hit?: boolean }> = ({
  ...
  <svg viewBox="0 0 48 48" width={size} height={size}>
    ...
    {/* 에너지 날개 */}
    <path
      d="M4,24 L18,16 L18,32Z"
      fill="#f1c40f"
      opacity="0.4"
      className="engine-flame"
    />
    <path
      d="M44,24 L30,16 L30,32Z"
      fill="#f1c40f"
      opacity="0.4"
      className="engine-flame"
    />
...
export const SpaceBossSvg: React.FC<{
  ...
  const bodyColor =
    hpRatio > 0.5 ? "#2c3e50" : hpRatio > 0.25 ? "#922b21" : "#641e16";
  const glowColor =
    hpRatio > 0.5 ? "#3498db" : hpRatio > 0.25 ? "#e74c3c" : "#ff0000";
  return (
    <svg viewBox="0 0 160 120" width={size} height={(size * 120) / 160}>
      ...
      {/* 메인 동체 */}
      <path
        d="M30,60 Q80,10 130,60 L120,90 Q80,110 40,90Z"
        fill={bodyColor}
        stroke="#1a252f"
        strokeWidth="1.5"
      />
      ...
      {/* 날개 우 */}
      <path
        d="M130,60 L156,75 L150,55 L130,50Z"
        fill={bodyColor}
        stroke="#1a252f"
        strokeWidth="1"
      />
      {/* 상부 구조물 */}
      <path
        d="M60,35 Q80,15 100,35 L95,50 Q80,55 65,50Z"
        fill="#34495e"
        stroke="#2c3e50"
        strokeWidth="1"
      />
